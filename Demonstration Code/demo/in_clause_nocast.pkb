...
IS
   ...
   FUNCTION nested_table_list3 ( list_in IN pky_nt )
      RETURN sys_refcursor
   IS
      retval sys_refcursor;
   BEGIN
   ...
   IS
      ...
      PROCEDURE test_nds_table_list3
      IS
         l_cv    sys_refcursor;
         l_one   in_clause_tab%ROWTYPE;
      BEGIN
         init_test ('Output from NDS_TABLE_LIST3s');

         FOR indx IN 1 .. iterations_in
         LOOP
            l_cv := nds_table_list3 ('1,3');
...
Output from NDS_LIST
  Elapsed CPU time: 249
Output from NDS_BULK_LIST
  Elapsed CPU time: 227
Output from NDS_BULK_LIST2
  Elapsed CPU time: 279
Output from DBMS_SQL_LIST
  Elapsed CPU time: 245
Output from NESTED_TABLE_LIST
  Elapsed CPU time: 326
Output from MEMBER_OF_LIST
  Elapsed CPU time: 1018
Output from STATIC_IN_LIST
  Elapsed CPU time: 365
Output from STATIC_IN_LIST_SMALL(50)
  Elapsed CPU time: 368
*/  
END in_clause;
/
