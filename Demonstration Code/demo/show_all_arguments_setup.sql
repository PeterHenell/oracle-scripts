...
DROP TYPE anobject_t FORCE
/

CREATE OR REPLACE TYPE anobject_t AS OBJECT
                  (keyno NUMBER, name VARCHAR2 (100));
/

CREATE OR REPLACE TYPE varray_t AS VARRAY (100) OF anobject_t;
/
...
IS
   ...
   PROCEDURE valid_diffnum (arg1   IN INTEGER
                          , arg2   IN VARCHAR2
                          , arg3   IN VARCHAR2);
   ...
   PROCEDURE noparms (arg1   IN VARCHAR2 := NULL
                    , arg2   IN VARCHAR2
   ...
   PROCEDURE bad_datatypes (varchar2_in         IN VARCHAR2
                          , varchar_in             VARCHAR
   ...
   PROCEDURE composites2 (account_in    NUMBER
                        , person        person%ROWTYPE
                        , multirec      myrec2
                        , myobject      anobject_t);
