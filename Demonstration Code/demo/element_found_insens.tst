...
-- These are then each called in the executable section of the main block.
   ...
   IS
      ...
      PROCEDURE run_test_case (
        ...
        ,case_insensitive_in   IN   BOOLEAN DEFAULT FALSE
      )
      IS
      BEGIN
         l_element_found :=
            element_found (collection_in            => collection_in
                          ...
                          ,case_insensitive_in      => case_insensitive_in
                          );
   ...
   BEGIN
      ...
      run_test_case
         (test_case_name_in        => 'Case sensitive search lower case value not found'
         ,collection_in            => g_collection
         ,value_in                 => 'def'
         ,start_index_in           => NULL
         ,end_index_in             => NULL
         ...
         ,expected_value_in        => FALSE
         ,test_type_in             => 'EQ'
         ,case_insensitive_in      => FALSE
         );
      run_test_case
         (test_case_name_in        => 'Case insensitive search lower case value found'
         ,collection_in            => g_collection
         ,value_in                 => 'def'
         ,start_index_in           => NULL
         ,end_index_in             => NULL
