...
| Created On: April 21, 2006 20:21:26
...
IS
   ...
   -- Delete all rows for this EMP_MGR_FK foreign key value
   ...
   PROCEDURE initrec (
      employee_inout IN OUT EMPLOYEE_TP.EMPLOYEE_rt
   );

   FUNCTION initrec RETURN EMPLOYEE_TP.EMPLOYEE_rt;
