CREATE OR REPLACE FUNCTION recompile (o_owner    IN VARCHAR2 := USER
                                    , o_name     IN VARCHAR2 := '%'
                                    , o_type     IN VARCHAR2 := '%'
...
--
--
-- DESCRIPTION: Recompile Utility is designed  to compile PL/SQL program units.
--
         ...
         THEN
            ...
            THEN
               DBMS_OUTPUT.put_line (
                  ...
                  || ' is recompiled. Object status before is '
                  || object_status
                  || '.');
               DBMS_OUTPUT.put_line (recompile_record.stmt || '.');
            END IF;
