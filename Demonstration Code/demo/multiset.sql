...
BEGIN
   INSERT INTO birds
   VALUES ('spiro glockeel', 'northern hamrall', color_array_t ('RED', 'YELLOW', 'GREEN')
          );

   INSERT INTO birds
   VALUES ('blouring tumswitch', 'darkwing chilata', color_array_t ('BROWN', 'ORANGE')
          );
END;
/
...
BEGIN
   ...
   DBMS_OUTPUT.
   put_line ('Countries in which the "' || bird_row.genus || '" is found:');
