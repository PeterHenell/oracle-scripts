...
/* First, camel notation: looks cool, cannot auto format 

CREATE TYPE stringListNT IS TABLE OF VARCHAR2 (32767);
/

CREATE OR REPLACE FUNCTION valueIsInList (theList    IN stringListNT,
                                          theValue   IN varchar2)
   RETURN number
*/

/* OK, here's a PL/SQL function with delimited name.
