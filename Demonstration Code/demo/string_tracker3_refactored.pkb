...
IS
   ...
   BEGIN
      ...
      */
      ...
      /* Zagreb Sept 2008 - simplify simplify, simply RETURN the EXISTS at this point. */
   ...
   IS
      l_list_record      list_rt;
      l_list_of_values   used_aat;
   BEGIN
      assert (list_name_in IS NOT NULL
            , 'You must provide a non-NULL name for your list!'
             );
      ...
      l_list_record := g_list_of_lists (list_name_in);
      --
      l_list_of_values := l_list_record.list_of_values;
      --
      l_list_of_values (value_string_in) := TRUE;
      --
